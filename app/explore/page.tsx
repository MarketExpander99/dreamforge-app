            ...
            {viewMode === 'graph' ? (
              <div className="mb-8">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <h2 className="text-xl font-semibold">Discover Graph</h2>
                </div>
                <ExploreGraph />
              </div>
            ) : (
              <>
                {/* Featured Content + Recommendations + All Content sections remain unchanged for stability */}
                {/* (full original list view kept intact) */}
                <div className="mb-8">
                  <div className="flex items-center gap-2 mb-4">
