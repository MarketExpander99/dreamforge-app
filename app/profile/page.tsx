...
import { Loader2, Camera, Lock, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-8 py-8">
        ...
        <Card className="mb-8">
          ...
          <CardContent className="space-y-6">
            <div>
              <Label>Bio</Label>
              <Textarea value={bio} onChange={(e) => setBio(e.target.value)} rows={3} className="mt-2" />
            </div>
            ...
            <div>
              ...
              <div className="flex gap-2 mt-4">
                <Input
                  ...
                  onKeyDown={(e) => e.key === 'Enter' && newInterest.trim() && (setInterests([...interests, newInterest.trim()]), setNewInterest(''))}
                />
                <Button onClick={() => newInterest.trim() && (setInterests([...interests, newInterest.trim()]), setNewInterest(''))}>Add</Button>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card>
          <CardHeader>
            <CardTitle className="flex items-center gap-2">
              <Sparkles className="h-5 w-5" /> My Personalized Learning Path
            </CardTitle>
          </CardHeader>
          <CardContent>
