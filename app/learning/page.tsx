...
export default function LearningPage() {
  ...
  // Auto-generate path + courses once we have queries
  useEffect(() => {
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <Card className="border-0 shadow-sm bg-white dark:bg-zinc-900 mb-8">
            <CardHeader>
              ...
              <CardDescription>These drive your personalized recommendations (powered by your discovery data and chatlogs)</CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="border-0 shadow-sm bg-white dark:bg-zinc-900 mb-8">
            <CardHeader>
              ...
              <CardDescription>Step-by-step path tailored to your unique questions and goals</CardDescription>
            </CardHeader>
          ...
          {/* Suggested Formal Courses - NEW SECTION from discovery + chat history */}
          <Card className="border-0 shadow-sm bg-white dark:bg-zinc-900">
            <CardHeader>
              ...
              <CardDescription>
                High-quality structured courses from top providers. Complements your personalized path. Click to enroll or audit.
              </CardDescription>
            </CardHeader>
            <CardContent>
              ...
              <p className="text-[10px] text-zinc-400 dark:text-zinc-500 mt-6 text-center">
                Recommendations derived in real-time from your saved searches, questions, and AI interaction history. No additional data stored.
              </p>
            </CardContent>
          </Card>
        </div>
